...
INSERT INTO "new_patrimonio" ("categoria", "codigo_publico", "descricao", "id_fornecedor", "id_patrimonio", "nome", "preco_unitario", "status", "unidade_medida") SELECT "categoria", "codigo_publico", "descricao", "id_fornecedor", "id_patrimonio", "nome", "preco_unitario", "status", "unidade_medida" FROM "patrimonio";
