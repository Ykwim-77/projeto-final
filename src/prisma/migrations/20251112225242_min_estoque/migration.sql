...
CREATE TABLE "new_patrimonio" (
    ...
    "min_estoque" INTEGER NOT NULL DEFAULT 1,
...
INSERT INTO "new_patrimonio" ("categoria", "codigo_publico", "descricao", "estoque", "id_fornecedor", "id_patrimonio", "nome", "preco_unitario", "status", "unidade_medida") SELECT "categoria", "codigo_publico", "descricao", "estoque", "id_fornecedor", "id_patrimonio", "nome", "preco_unitario", "status", "unidade_medida" FROM "patrimonio";
