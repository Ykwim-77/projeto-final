...
INSERT INTO "new_emprestimo" ("data_pedido", "data_recebimento", "id_emprestimo", "id_patrimonio", "id_usuario", "observacoes", "status", "valor_total") SELECT "data_pedido", "data_recebimento", "id_emprestimo", "id_patrimonio", "id_usuario", "observacoes", "status", "valor_total" FROM "emprestimo";
